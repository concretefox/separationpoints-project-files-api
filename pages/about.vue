    ...
    <div class="flex-1 flex overflow-y-hidden">
      ...
      >
        <ul class="py-6">
          ...
          <li class="border-l-4 border-600">
            <a href="#" class="flex items-center mx-4 mt-4 group">
              <svg
                class="fill-current text-white group-hover:text-white h-6 w-6"
                viewBox="0 0 24 24"
      ...
      <div class="bg-gray-800-spotify flex-1 flex flex-col">
        ...
        <div class="content-about overflow-y-auto">
          <div class="container mx-auto">
            <h2 class="mt-24 text-5xl font-semibold text-white">About</h2>
            ...
            <div class="flex items-center mt-4 -mx-4">
              ...
              <div class="w-1/4 px-4">
                <p class="font-semibold text-xl border-b border-gray-900 pb-2">
                  Influenced by Jazz, World, Latin America & a whole heap in
                  between.
                </p>
                <p>
                  Podcasts streamed on the 1st of the month. Twitch, Youtube
                  Instagram & Mixcloud - @separationpoints Bookings:
                  <strong> separationpoints@live.com</strong>
                </p>
              </div>
            </div>
            ...
            <div class="mt-12">
              ...
              <div class="flex items-center mt-4 -mx-4">
                ...
                <div class="w-1/5 px-4">
                  <div>
                    <a
                      href="https://www.facebook.com/separationpointspodcast"
                      target="blank"
                      ><img
                    ...
                    <a
                      href="https://www.instagram.com/separationpoints"
                      target="blank"
                      ><img
                    ...
                    <a
                      href="https://www.mixcloud.com/separationpoints/"
                      target="blank"
                      ><img
                        src="~/assets/img/mixcloud-logo-black.jpg"
                        alt="album cover"
                        height="50"
                        width="50"
                    /></a>
